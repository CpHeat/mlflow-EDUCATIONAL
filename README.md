...
Le workflow MLOps de ce projet est documenté pas à pas dans deux notebooks principaux :
...
2. Démarrez Jupyter Lab à la racine du projet :
   ...
   jupyter lab
   ```
3. Exécutez le `01_Benchmark_Modeles.ipynb` en entier. Vérifiez que les modèles expérimentés apparaissent dans l'interface MLflow (http://localhost:5000).
